...
export const tracks: Tracks = {
  ...
  FOUNDATIONS: {
    ...
    milestones: [
      ...
      },
      {
        ...
        examples: [
          "Defined and developed Stratasan's continuous delivery strategy",
  ...
  MENTORSHIP: {
    ...
    milestones: [
      ...
      {
        summary:
          "Teaches small groups of engineers and contributes to Stratasan's shared knowledge base",
        signals: [
    ...
    milestones: [
      ...
      },
      {
        ...
        signals: [
          ...
          "Drives recognition and adoption of Stratasan in significant numbers"
        ],
        examples: [
    ...
    milestones: [
      ...
      },
      {
        ...
        signals: [
          ...
          "Holds individuals, teams, and leadership accountable to Stratasan's values",
